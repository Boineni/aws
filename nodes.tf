...
resource "aws_eks_node_group" "private-sample" {
  cluster_name    = aws_eks_cluster.raju.name
  node_group_name = "private-sample"
  node_role_arn   = aws_iam_role.sample.arn
